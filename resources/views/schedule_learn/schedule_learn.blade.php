...
@endif
<br>
<a href="{{route('schedule.get')}}" type="button" class="btn btn-primary float-left pL-50"><i class="fas fa-plus"></i> Thêm lịch học</a>
<br><br>
<div class="card">
            ...
            @foreach ($schedule as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('schedule.update',$item->id)}}" class="btn btn-primary">Sửa</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
